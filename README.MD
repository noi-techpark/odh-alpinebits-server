...
- [Howto request data?](#Howto-request-data)
...
```bash
java -jar application-spring/target/application-spring-0.5.0.jar it.bz.opendatahub.alpinebitsserver.application.spring.Application 
```
...
The response whould look like this:
