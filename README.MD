...
In the test client insert the following configuration:
...
You need to create a XML file, which we call handshaking.xml This file contains some request parameter requested by an AlpineBits request.
