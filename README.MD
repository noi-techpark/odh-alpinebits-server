...
```bash
ALPINEBITS_ODH_USERNAME=XXX ALPINEBITS_ODH_PASSWORD=YYY java -jar application-spring/target/application-spring-0.2.0.jar it.bz.opendatahub.alpinebitsserver.application.spring.Application 
```
