...
public final class InventoryPushMiddlewareBuilder {
    ...
    public static Middleware buildInventoryPushMiddleware() {
        return ComposingMiddlewareBuilder.compose(Arrays.asList(
                XmlMiddlewareBuilder.buildXmlToObjectConvertingMiddleware(OTA_INVENTORY_PUSH_REQUEST, AlpineBitsVersion.V_2020_10),
                XmlMiddlewareBuilder.buildObjectToXmlConvertingMiddleware(OTA_INVENTORY_PUSH_RESPONSE, AlpineBitsVersion.V_2020_10),
