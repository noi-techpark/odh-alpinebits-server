...
public final class FreeRoomsPushMiddlewareBuilder {
    ...
    public static Middleware buildFreeRoomsPushMiddleware() throws JAXBException {
        return ComposingMiddlewareBuilder.compose(Arrays.asList(
                XmlMiddlewareBuilder.buildXmlToObjectConvertingMiddleware(OTA_FREE_ROOMS_PUSH_REQUEST, AlpineBitsVersion.V_2018_10),
                XmlMiddlewareBuilder.buildObjectToXmlConvertingMiddleware(OTA_FREE_ROOMS_PUSH_RESPONSE, AlpineBitsVersion.V_2018_10),
